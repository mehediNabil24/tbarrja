...
export default function ProductsSection() {
  ...
  return (
    <section
      id="product"
      className="relative px-6 py-12 sm:py-16 lg:px-12 lg:py-24 bg-transparent text-justify"
    >
      <div className="mx-auto container">
        <div className="grid gap-8 sm:gap-12 lg:gap-16 grid-cols-1 lg:grid-cols-2 items-center">
          {/* Left Image - shows after text on mobile/tablet, first on desktop */}
          ...
          {/* Right Content - shows first on mobile/tablet, second on desktop */}
          <div className="space-y-4 sm:space-y-4 lg:space-y-10 order-1 lg:order-2">
